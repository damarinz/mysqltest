...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { deviceid: @sensor.deviceid, log: @sensor.log, value: @sensor.value } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { deviceid: @sensor.deviceid, log: @sensor.log, value: @sensor.value } }
